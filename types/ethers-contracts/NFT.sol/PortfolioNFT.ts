...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface PortfolioNFTInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "getApproved" | "isApprovedForAll" | "name" | "owner" | "ownerOf" | "renounceOwnership" | "safeMint" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "transferOwnership" | "withdraw"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "BatchMetadataUpdate" | "MetadataUpdate" | "Minted" | "OwnershipTransferred" | "Transfer" | "Withdraw"): EventFragment;
...
decodeFunctionResult(functionFragment: 'withdraw', data: BytesLike): Result;
    ...
    export namespace MintedEvent {
      export type InputTuple = [to: AddressLike, tokenId: BigNumberish, price: BigNumberish];
      export type OutputTuple = [to: string, tokenId: bigint, price: bigint];
      export interface OutputObject {to: string, tokenId: bigint, price: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface PortfolioNFT extends BaseContract {
    
    connect(runner?: ContractRunner | null): PortfolioNFT;
    waitForDeployment(): Promise<this>;

    interface: PortfolioNFTInterface;
...
getEvent(key: 'Withdraw'): TypedContractEvent<WithdrawEvent.InputTuple, WithdrawEvent.OutputTuple, WithdrawEvent.OutputObject>;
    ...
    filters: {
      ...
      'Minted(address,uint256,uint256)': TypedContractEvent<MintedEvent.InputTuple, MintedEvent.OutputTuple, MintedEvent.OutputObject>;
